    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          {/* Single card */}
          <a
            href="https://github.com/Euphoria99/TodoApp"
            target="__blank"
          ...
          {/* Single card */}
          <a
            href="https://github.com/Euphoria99/Volunteer-Status-Notifier"
            target="__blank"
          ...
          {/* Single card */}
          <a
            href="https://github.com/Euphoria99/Chat_App"
            target="__blank"
          ...
          >
           ...
           {/* Single card */}
          <a
            href="https://github.com/Euphoria99/QrPix"
            target="__blank"
            className="w-full block col-span-3  sm:col-span-2 shadow-2xl"
          >
            <div className="relative overflow-hidden">
